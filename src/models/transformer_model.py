...
class GraphTransformer(nn.Module):
    ...
    def forward(self, X, E, y, node_mask, cad_vec):
        ...
        diag_mask = diag_mask.unsqueeze(0).unsqueeze(-1).expand(bs, -1, -1, -1)  # 禁止自环

        X_to_out = X[..., :self.out_dim_X]  # [512, 48, 13]
        E_to_out = E[..., :self.out_dim_E]
        y_to_out = y[..., :self.out_dim_y]

        new_E = self.mlp_in_E(E)  # [512, 9, 9, 64]
        new_E = (new_E + new_E.transpose(1, 2)) / 2  # 无向图强制对称
